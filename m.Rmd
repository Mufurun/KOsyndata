...
- This looks much better than previous ones with very high eff value.
### Posterior Check 
...
- The red solid line is the mean and dashed lines are 95% percentile interval. if the most of datpoints are inside the percentile interval, the simulated data is very simular to the original data. 
##### Model K 
