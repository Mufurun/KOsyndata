...
m3<- ulam(
    ...
    # Model S 
        ...
        bS_T_bar ~ normal(0, 0.3), # regularization
        sigma_bS_T ~ exponential(1), 
        z_bS_T[T] ~ normal(0, 0.01),
...
SLseq<-seq(0, 1, len = 20)
KbySL<- sapply(SLseq,  
    function (i) inv_logit(rep(post$aK, 25) + rep(post$bK_S, 25) * d$S + rep(post$bK_SL, 25) * i + rep(post$bK_Y, 25) * post$Y + rep(post$bK_dK, 25) * d$dK + colMeans(post$bK_T)) )
means<- apply( KbySL , 2 , mean )
PIs<- apply( KbySL , 2 , PI )
lines(SLseq, means, col = 2, lwd = 3)
lines(SLseq, PIs[1, ], col = 2, lty = 2, lwd = 3)
...
Sseq<-seq(0, 0.5, len = 20)
KbyS<- sapply(Sseq, 
    function (i) inv_logit(rep(post$aK, 25) + rep(post$bK_S, 25) * i + rep(post$bK_SL, 25) * post$SL + rep(post$bK_Y, 25) * post$Y + rep(post$bK_dK, 25) * d$dK + colMeans(post$bK_T)) )
means<- apply( KbyS , 2 , mean )
PIs<- apply( KbyS , 2 , PI )
lines(Sseq, means, col = 2, lwd = 3)
lines(Sseq, PIs[1, ], col = 2, lty = 2, lwd = 3)
...
dKseq<-seq(-2.5, 2, len = 20)
KbydK<- sapply(dKseq, 
    function (i) inv_logit(rep(post$aK, 25) + rep(post$bK_S, 25) * d$S + rep(post$bK_SL, 25) * post$SL + rep(post$bK_Y, 25) * post$Y + rep(post$bK_dK, 25) * i + colMeans(post$bK_T)) )
PIs<- apply( KbydK , 2 , PI )
means<- apply( KbydK , 2 , mean )
lines(dKseq, means, col = 2, lwd = 3)
lines(dKseq, PIs[1, ], col = 2, lty = 2, lwd = 3)
...
Yseq<-seq(-16, -2.4, len = 20)
KbyY<- sapply(dKseq, 
    function (i) inv_logit(rep(post$aK, 25) + rep(post$bK_S, 25) * d$S + rep(post$bK_SL, 25) * post$SL + rep(post$bK_Y, 25) * i + rep(post$bK_dK, 25) * d$dK + colMeans(post$bK_T)) )
PIs<- apply( KbyY , 2 , PI )
means<- apply( KbyY , 2 , mean )
lines(Yseq, means, col = 2, lwd = 3)
lines(Yseq, PIs[1, ], col = 2, lty = 2, lwd = 3)
...
plot(T, d$K)
KbyT<- sapply(1:25, 
    function (i) inv_logit(post$aK + post$bK_S * d$S + post$bK_SL * colMeans(post$SL) + post$bK_Y * colMeans(post$Y) + post$bK_dK * d$dK + post$bK_T[,i]) )
PIs<- apply( KbyT , 2 , PI )
...
dSseq<-seq(-2, 2, len = 20)
SbydS<- sapply(dSseq, 
    function (i) inv_logit(post$aS + post$bS_dS * i + post$bS_Y * colMeans(post$Y) + mean(post$bS_T)))
PIs<- apply( SbydS , 2 , PI )
means<- apply( SbydS , 2 , mean )
lines(dSseq, means, col = 2, lwd = 3)
lines(dSseq, PIs[1, ], col = 2, lty = 2, lwd = 3)
...
Yseq<-seq(-16, -2.4, len = 20)
SbyY<- sapply(Yseq, 
    function (i) inv_logit(post$aS + post$bS_dS * d$dS + post$bS_Y * i + mean(post$bS_T)))
means<- apply( SbyY , 2 , mean )
PIs<- apply( SbyY , 2 , PI )
lines(Yseq, means, col = 2, lwd = 3)
lines(Yseq, PIs[1, ], col = 2, lty = 2, lwd = 3)
...
plot(T, d$S)
SbyT<- sapply(1:25, 
    function (i) inv_logit(post$aS + post$bS_dS * d$dS + post$bS_Y * colMeans(post$Y) + post$bS_T[,i]))
PIs<- apply( SbyT , 2 , PI )
