...
\begin{tikzpicture}[
    ...
    \draw [->] (U) -- (K);
\end{tikzpicture}
\caption{DAG of causalities with hierarchical modeling with stratified by T (Model 2) - See Figure 1 for notations. }
\end{figure}
...
\begin{tikzpicture}[
    ...
    \draw [->] (U) -- (K);
\end{tikzpicture}
\caption{DAG of causalities with some hierarchical modeling with stratified by T (Model 3) - causality of Y -> S are ignored as it is represented in auto-correlation between S and SL, though Y -> SL is needed to estimate hidden SL. See Figure 1 for notations. }
\end{figure}
