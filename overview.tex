...
$$logit(\mu_S) = \alpha _S [T] + \beta _{S_Y} \cdot Y + \beta _ {S_{dS}} * dS$$
\begin{itemize}
...
\item Model S 
\begin{itemize}
    \item Belows are the same coding as M1
\end{itemize}
$$S \sim Normal(\mu_S, \sigma_S)$$
...
\begin{itemize}
    \item Basically same as m1 but not regularization (no pooling). 
...
\item Model S 
\begin{itemize}
    \item Belows are similar to M1, though $\beta _{S_T}$ are added. 
\end{itemize}
$$S \sim Normal(\mu_S, \sigma_S)$$
$$logit(\mu_S) = \alpha _S + \beta _ {S_{dS}} \cdot dS + \beta _{S_Y} \cdot Y + \beta _{S_T}[T]$$
$$\alpha_S, \beta _{S_Y}, \beta {S_{dS}} \sim Normal(0,0.1)$$

$$\beta _{S_T} = \overline{\beta _{S_T}} + \sigma_{\beta _{S_T}} * z_{\beta_{S_T}}[T]$$
$$\overline{\beta {S_T}} \sim Normal(0, 0.1)$$
