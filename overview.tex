...
\begin{itemize}
    ...
    \begin{itemize}
        \item See the m1.Rmd and m1.html
    \end{itemize}
\end{itemize}
...
we can estimate Y by T, which lead to SL. So, in this case, I put SL depending on T. 
\\
\\
...
The priors and statistical model for m1
\begin{itemize}
 \item Main model K
...
\begin{itemize}
    ...
    \item In this case (m1.2), we do include correlation between S and SL due to Y. 
\end{itemize}
...
\end{itemize}
$$\beta _{K_S}, \beta _{K_SL} \sim Multi_normal(\overline{\beta _b{K_S}}, \overline{\beta _b{K_SL}}, \rho _{S, SL}, \sigma _{S, SL})$$
...
$$\overline{\alpha _S} \sim Normal(0,0.1)$$
$$\sigma_{\alpha _S} \sim Exponential(6)$$
$$z_{\alpha _S}[T] \sim Normal(0,0.05)$$

$$\beta _{S_Y} = \overline{\beta _{S_Y}} + \sigma _{\beta _{S_Y}} * z _ {\beta _{S_Y}}[T]$$
$$\overline{\beta _{S_Y}} \sim Normal(0,0.1) $$
$$\sigma _{\beta _{S_Y}} ~ Exponential(6)$$
